...
const CategoryBanner: React.FC<CategoryBannerProps> = ({ 
  ...
  return (
    <div className="relative w-full h-80 md:h-[320px] bg-gradient-to-r from-brand-black via-[#47B139]/20 to-brand-black rounded-2xl overflow-hidden shadow-2xl flex flex-row">
